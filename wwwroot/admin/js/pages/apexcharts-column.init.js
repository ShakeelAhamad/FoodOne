...
var chartColumnColors = getChartColorsArray("column_chart"),
    ...
    dumbbellChartColors =
        (groupedStackedColors &&
            ((options = {
                series: [
                    { name: "Q1 Budget", group: "budget", data: [44e3, 55e3, 41e3, 67e3, 22e3, 43e3] },
                    { name: "Q1 Actual", group: "actual", data: [48e3, 5e4, 4e4, 65e3, 25e3, 4e4] },
                    { name: "Q2 Budget", group: "budget", data: [13e3, 36e3, 2e4, 8e3, 13e3, 27e3] },
                    { name: "Q2 Actual", group: "actual", data: [2e4, 4e4, 25e3, 1e4, 12e3, 28e3] },
                ],
                chart: { type: "bar", height: 350, stacked: !0 },
                stroke: { width: 1, colors: ["#fff"] },
                dataLabels: { formatter: (e) => e / 1e3 + "K" },
                plotOptions: { bar: { horizontal: !1 } },
                xaxis: { categories: ["Online advertising", "Sales Training", "Print advertising", "Catalogs", "Meetings", "Public relations"] },
                fill: { opacity: 1 },
    ...
    chartColumnMarkersColors =
        (dumbbellChartColors &&
            ((options = {
                ...
                plotOptions: { bar: { isDumbbell: !0, columnWidth: 3, dumbbellColors: dumbbellChartColors } },
                legend: { show: !0, showForSingleSeries: !0, position: "top", horizontalAlign: "left", customLegendItems: ["Product A", "Product B"] },
                fill: { type: "gradient", gradient: { type: "vertical", gradientToColors: ["#00E396"], inverseColors: !0, stops: [0, 100] } },
...
function updateQuarterChart(e, t) {
    ...
    if (e.w.globals.selectedDataPoints[0]) {
        for (var r = e.w.globals.selectedDataPoints, s = 0; s < r[0].length; s++) {
            ...
            o.push({ name: n.data[l].x, data: n.data[l].quarters }), a.push(n.data[l].color);
        }
        return 0 === o.length && (o = [{ data: [] }]), ApexCharts.exec(t, "updateOptions", { series: o, colors: a, fill: { colors: a } });
    }
}
var chart,
    optionsGroup,
    ...
    options = {
        ...
        chart: {
            ...
            events: {
                dataPointSelection: function (e, t, o) {
                    ...
                    1 !== o.selectedDataPoints[0].length || a.classList.contains("active") || (r.classList.add("chart-quarter-activated"), a.classList.add("active")),
                        updateQuarterChart(t, "barQuarter"),
                        0 === o.selectedDataPoints[0].length && (r.classList.remove("chart-quarter-activated"), a.classList.remove("active"));
                },
                updated: function (e) {
        ...
        plotOptions: { bar: { distributed: !0, horizontal: !0, barHeight: "75%", dataLabels: { position: "bottom" } } },
        dataLabels: {
            enabled: !0,
            textAnchor: "start",
            style: { colors: ["#fff"] },
        ...
        colors: colors,
        states: { normal: { filter: { type: "desaturate" } }, active: { allowMultipleDataPointsSelection: !0, filter: { type: "darken", value: 1 } } },
        tooltip: {
            x: { show: !1 },
            y: {
                title: {
    ...
    optionsQuarter =
        ...
        {
            series: [{ data: [] }],
            chart: { id: "barQuarter", height: 330, width: "100%", type: "bar", stacked: !0 },
            plotOptions: { bar: { columnWidth: "50%", horizontal: !1 } },
            legend: { show: !1 },
            grid: { yaxis: { lines: { show: !1 } }, xaxis: { lines: { show: !0 } } },
            yaxis: { labels: { show: !1 } },
            title: { text: "Quarterly Results", offsetX: 10, style: { fontWeight: 500 } },
            tooltip: {
                x: {
                    formatter: function (e, t) {
    ...
    chartColumnGroupLabelsColors =
        (chartColumnDistributedColors &&
            ((options = {
                ...
                chart: { height: 350, type: "bar", events: { click: function (e, t, o) {} } },
