var str_dt = function (e) {
    var e = new Date(e),
        ...
        t = (t = t[1]) < 10 ? "0" + t : t;
    return (
        (month = "" + ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"][e.getMonth()]),
        (day = "" + e.getDate()),
        (year = e.getFullYear()),
...
document.getElementById("showModal").addEventListener("show.bs.modal", function (e) {
    e.relatedTarget.classList.contains("edit-item-btn")
        ...
        : ((document.getElementById("exampleModalLabel").innerHTML = "List Order"), (document.getElementById("showModal").querySelector(".modal-footer").style.display = "none"));
}),
ischeckboxcheck(),
    ...
    (Array.prototype.slice.call(forms).forEach(function (a) {
        a.addEventListener(
            ...
            function (e) {
                ...
                a.checkValidity()
                    ? (e.preventDefault(),
                      "" === customerNameField.value || "" === productNameField.value || "" === dateField.value || "" === amountField.value || "" === paymentField.value || editlist
                          ? "" !== customerNameField.value &&
                            ...
                            clearFields(),
                            Swal.fire({ position: "center", icon: "success", title: "Order updated Successfully!", showConfirmButton: !1, timer: 2e3, showCloseButton: !0 }))
                          : (orderList.add({
                            ...
                            filterOrder("All"),
                            count++,
                            Swal.fire({ position: "center", icon: "success", title: "Order inserted successfully!", showConfirmButton: !1, timer: 2e3, showCloseButton: !0 })))
            ...
            e.addEventListener("click", function (e) {
                ...
                Array.from(e).forEach(function (e) {
                    ...
                    t == itemId &&
                        ...
                        (productnameVal = new Choices(productNameField, { searchEnabled: !1 })),
